...
THREE.GPUParticleSystem = function(options) {
  ...
  var GPUParticleShader = {
    ...
    vertexShader: [
	  ...
	  'newPosition.z = 0.0;', // ADDED THIS BECAUSE I'M USING A 2D VIEW
  ...
  this.update = function(time, scale) {
    for (var i = 0; i < self.PARTICLE_CONTAINERS; i++) {

      self.particleContainers[i].update(time, scale);
...
THREE.GPUParticleContainer = function(maxParticles, particleSystem) {
  ...
  this.spawnParticle = function(options) {
	...
	self.PARTICLE_CURSOR = (self.PARTICLE_CURSOR + 1) % self.PARTICLE_COUNT;
  ...
  this.update = function(time, scale) {
	...
	self.particleShaderMat.uniforms['uScale'].value = scale;
